...
%%
	\frame{
		...
		\centerline{\includegraphics[width=1.2\textwidth]{figs/ml-landscape.png}}
	}
%%%%//////////////////////////////////////////////////////////////////////////////////////////////%% 3
%%
	\frame{
		...
		Matching network is one of the metric-based meta-learning works that targeting k-shot classification problems.

		\centerline{\includegraphics[width=1.2\textwidth]{figs/matching-networks.png}}
	}
...
%%
	\frame{
		\frametitle{Meta-learning is a huge field}
		\textbf{Meta network}
		Meta Networks , short for MetaNet, is a meta-learning model with architecture and training process designed for \ccy{rapid generalization across tasks}.
		me
		\centerline{\includegraphics[width=1.2\textwidth]{figs/meta-network.png}}
	}
