...
When there are enough samples for dataset $\mathcal{D}$, we can achieve ideal result of the model above. However, this may be difficult or even not possible. In order to learn from a limited number of examples with supervised information, a new machine learning paradigm called Few-Shot Learning (FSL) is proposed.
